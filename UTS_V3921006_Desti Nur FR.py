...
if __name__ == "__main__": 
  string = "CEMMOCCSCXYDPSXKVPKSVEBOSCXYDPKDKVSDSCDROMYEBKQODYMYXDSXEODRKDMYEXDC"
  keyword = "DESTIDESTIDESTIDESTIDESTIDESTIDESTIDESTIDESTIDESTIDESTIDESTIDESTIDES"
